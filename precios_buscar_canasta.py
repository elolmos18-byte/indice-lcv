...
# Estas funciones se movieron a precios_normalizar_unidades.py (son puras:
# texto entra, numero sale - separarlas hace mas facil encontrar y testear
# el proximo caso raro sin leer todo este archivo). Se importan tal cual
# se usaban antes, asi que el resto del script no cambia.
from precios_normalizar_unidades import (
    normalizar,
    extraer_gramos,
    extraer_mililitros,
    extraer_unidades,
    extraer_metros_totales,
    extraer_panos_totales,
    calcular_precio_normalizado,
)
